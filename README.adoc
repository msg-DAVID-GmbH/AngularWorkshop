...
== Tooling
* probably best IDE: https://www.jetbrains.com/webstorm/[WebStorm] (because IntelliJ is the best Java IDE, so WebStorm which is also from JetBrains should be the best IDE for Java Script. I guess.
* 30-day-trial available
* Creating new Angular and/or Angular CLI project possible via the IDE. Maybe the better way to create new projects in the future.
