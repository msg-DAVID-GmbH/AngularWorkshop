...
These are notes and code snippets from the Udemy Workshop https://www.udemy.com/the-complete-guide-to-angular-2[The complete guide to Angular]. The "Course Project" is published https://github.com/msg-DAVID-gmbh/AngularCourseProject[here].
...
** directives
** components
* in component-binding, binding to self-specified, custom properties in self-written components
* type-definition in TypeScript via Java Script object:
[source]
----
...
* name of property viewed by the outside can be changed. The following makes the property visible as "myUltracoolProperty":
----
export class MyWrapper {
